...
import { Firestore, doc,deleteDoc, getDoc, updateDoc, serverTimestamp } from '@angular/fire/firestore';
...
export class ActualizarRegistroComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    this.route.paramMap.subscribe(async params => {
      ...
      // Fallback informativo desde la navegación (si el doc no trae nombre/apellido/unidad)
      ...
      try {
        ...
        this.registro = {
          ...
          // Si Firestore no trae estos campos, usamos los queryParams
...
async guardar(): Promise<void> {
  ...
  try {
    ...
    await updateDoc(ref, {
      ...
      // informativos (ya sabes que así los manejas)
